...
export function dispatch(method, params = {}) {
  if (method === 'initialize') return { protocolVersion: ['2024-11-05', '2025-03-26', '2025-06-18'].includes(params.protocolVersion) ? params.protocolVersion : '2025-06-18', capabilities: { tools: {}, resources: {}, prompts: {} }, serverInfo: { name: 'polyaccounts-demo', version: '1.0.2' }, instructions: 'This server contains only invented data. Its current month is August 2026. Cite entry IDs. This demo is read-only. The separately installed hosted connector provides company-scoped read and write access.' };
