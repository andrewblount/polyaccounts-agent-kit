...
Download [polyaccounts-demo.mcpb](https://github.com/andrewblount/polyaccounts-agent-kit/releases/download/v1.0.0/polyaccounts-demo.mcpb)
...
```json
{
  "mcpServers": {
    "polyaccounts-demo": {
      ...
      "args": [
        "--yes",
        "--package=https://github.com/andrewblount/polyaccounts-agent-kit/releases/download/v1.0.0/polyaccounts-agent-kit-1.0.0.tgz",
        "polyaccounts-demo"
      ]
    }
  }
...
Download [polyaccounts-hosted.mcpb](https://github.com/andrewblount/polyaccounts-agent-kit/releases/download/v1.0.0/polyaccounts-hosted.mcpb)
